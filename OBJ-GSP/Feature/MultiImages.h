...
public:
	MultiImages(const string& _file_name,
		...
		// ==========================================================
		// 【新增】在岗位说明书里写明：本打工人可以额外接收两车特征点！
		// ==========================================================
		const vector<cv::Point2f>& _custom_pts1 = vector<cv::Point2f>(), 
		const vector<cv::Point2f>& _custom_pts2 = vector<cv::Point2f>());
	...
	// ==========================================================
	// 【新增】打工人缝在自己衣服上的两个口袋，用来存放厂长交接给他的特征点
	// ==========================================================
	vector<cv::Point2f> custom_pts1;
	vector<cv::Point2f> custom_pts2;
	// ==========================================================
